...
export const SERVICES = [
  { title: 'Web Development', description: 'Building scalable and secure web applications.' },
  { title: 'App Development', description: 'Creating cross-platform mobile apps with React Native.' },
  { title: 'UX/UI Design', description: 'Designing intuitive and visually appealing interfaces.' },
  { title: 'Cybersecurity Analysis', description: 'Ensuring robust security for your applications.' },
...
export const FAQS = [
  {
    ...
    answer: 'Greencode is a full-stack development agency focused on delivering innovative and secure solutions.',
  },
  {
    question: 'How can I contact you?',
    answer: 'Use the contact form on our website, and we’ll get back to you promptly.',
  },
  {
    question: 'What technologies do you specialize in?',
    answer: 'We specialize in React, Node.js, MySQL, PostgreSQL, TypeScript, and Next.js.',
  },
  {
    question: 'Do you offer custom solutions?',
    answer: 'Yes, we tailor our services to meet your specific business needs.',
  },
  {
    question: 'What is your development process?',
    answer: 'We follow an agile methodology, ensuring transparency and collaboration throughout the project.',
  },
];
