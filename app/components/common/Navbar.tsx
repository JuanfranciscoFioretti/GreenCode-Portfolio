...
//             {/* <a href="/" className="text-primary hover:text-accent text-[16px]">Home</a> */}
...
//             <a href="#faq" className="block text-primary hover:text-accent text-[16px]" onClick={toggleMenu}>FAQ</a>
//             <ThemeTogglerWrapper />
//             <DevModeToggle />
//           </div>
//         </motion.div>
...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed top-0 w-full z-50 ${isOpen ? 'bg-transparent backdrop-blur-[12px]' : 'glassmorphism'}`} style={isOpen ? { border: 'none', borderRadius: '0', boxShadow: 'none' } : {}}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex">
              <Image src={LOGOS.primary} alt="Greencode Logo" width={120} height={40} priority />
